...
Connection:
Connect the Xiao on Grove Sheild and connect the rest as follows. 
Motor - "1 2 3v3 GND" port  
Sliding Potentiometer - "7 6 3v3 GND" port
Button - "9 10 3v3 GND"
Light Sensor - "5 4 3v3 GND" port 
