...
0x00,0xFC,0x3F,0x00,0x00,0x03,0xC0,0x00,0x00,0x03,0xC0,0x00,
0xF0,0xFF,0xFF,0x0F,0xF0,0xFF,0xFF,0x0F,0x0C,0x00,0x00,0x30,
...
0x30,0x00,0x00,0x0C,0x30,0x00,0x00,0x0C,0x30,0x00,0x00,0x0C,
0x30,0x00,0x00,0x0C,0x30,0x00,0x00,0x0C,0x30,0x00,0x00,0x0C,
0x30,0x00,0x00,0x0C,0xC0,0xFF,0xFF,0x03,0xC0,0xFF,0xFF,0x03,
  };
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0xCF,0xF3,0x00,0x00,0xD7,0xF3,0x00,0x00,0xCF,0xF3,0x00,
0x00,0xD7,0xF3,0x00,0x00,0xCF,0xF3,0x00,0x00,0xD7,0xF3,0x00,
0x00,0xCF,0xF3,0x00,0x00,0xD7,0xF3,0x00,0x00,0xCF,0xF3,0x00,
0x00,0xD7,0xF3,0x00,0x00,0xCF,0xF3,0x00,0x00,0xCF,0xF3,0x00,
0x00,0xCF,0xF3,0x00,0x00,0xCF,0xF3,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
};
...
void wiodisplay(){
  ...
  if(state=="run"){
   ...
   tft.drawXBitmap(74,3,GRAPH2, 32, 30,20<<11|25<<6|25);
    ...
    tft.drawRoundRect(5,50,300,180,20, TFT_WHITE);
    tft.fillRoundRect(8,55,300,180,20, TFT_GREEN);
    displayTraining();
    tft.setTextSize(2);
...
void displayTraining(){
    ...
    tft.drawCircle(20+old_pos,220-old_brightness/3, 20, TFT_WHITE);
...
int smartMotor(){
  while(digitalRead(WIO_KEY_C)){
    ...
    if (abs(old_brightness-brightness)>10 || old_pos!=pos){
      ...
      tft.fillRect(20+old_pos,220-old_brightness/3,10,old_brightness/3,TFT_GREEN);
      tft.fillRect(20+pos,220-brightness/3,10,brightness/3,TFT_BLUE);
